...
from djchat.server.api.v1.views import ServerListViewset

router = DefaultRouter()
router.register("server/api/v1/select", ServerListViewset)
...
urlpatterns = (
    [
        ...
        # User management
        path("users/", include("djchat.users.urls", namespace="users")),
